...
Once you obtain your key, insert it into a java class named 'SecretApiConstant.java' within the Utility dir for the app. add the following code:

public class SecretApiConstant {
